...
<template>
  ...
  <main
    ...
    <div class="space-y-2 text-center md:text-left px-10">
      ...
      <h1 class="text-4xl font-bold md:text-5xl text-white fadein-up">Qaysar Aqeel Nugraha</h1>
      <div class="py-2">
        <h1
      ...
      <div class="flex space-x-4 justify-center md:justify-start fadein-bot">
        <a href="https://www.instagram.com/qaysaraqeell" target="_blank" class="social-button">
          <i class='bx bxl-instagram text-2xl text-amber-200'></i>
        </a>
        <a href="https://www.tiktok.com/@user821770052140408?is_from_webapp=1&sender_device=pc" target="_blank" class="social-button">
          <i class='bx bxl-tiktok text-2xl text-amber-200'></i>
        </a>
        <a href="https://www.linkedin.com/in/qaysar-aqeel-2387642a6/" target="_blank" class="social-button">
          <i class='bx bxl-linkedin text-2xl text-amber-200'></i>
        </a>
      </div>
    </div>
...
export default {
  ...
  data() {
    return {
      toRotate: ["Student at SMK Telkom Sidoarjo", "Tech & Digital", " Artist Sketch & Illustration", "Bussines Enthusiast", "Junior Hacker"],
      period: 500,
      txt: '',
      loopNum: 0,
      isDeleting: false,
