    ...
    return {
      ...
      design: [
        ...
        },
        {
          ...
          imageUrl: 'https://cdn.worldvectorlogo.com/logos/adobe-illustrator-cc-3.svg',
          status: 'Advanced'
        },
        {
          id: 3,
        ...
        },
        {
          id: 4,
          name: 'Canva',
          imageUrl: 'https://cdn.worldvectorlogo.com/logos/canva-wordmark-2.svg',
          status: 'God'
        }
      ],
      tools: [
      ...
      <section
        ...
        <div class="md:w-7/12">
          <p class="mb-3 md:mb-7 fadein-left fadeins-1">
            &nbsp; &nbsp; &nbsp; Hi everyone! 👋 I'm Qaysar Aqeel Nugraha, a student of SMK Telkom Sidoarjo majoring in Network and Application Informatics System (SIJA)
            with great interest in technology, design, art, and entrepreneurship. I actively participate in various competitions and involved in organizations to develop 
            my leadership and teamwork skills. In addition, I am also a student of Hacker's Digital Talent Program focusing on Programming, where I continue to hone my skills in cybersecurity and web application development.
          </p>
          <p class="mb-3 fadein-left fadeins-2">
            &nbsp; &nbsp; &nbsp; Currently, I manage several businesses in the creative industry, particularly in the arts, with a focus on innovation and creative product development. Outside of that, 
            I love to draw and continue to explore the world of design and digital art. Happy to share my journey with you guys!
          </p>
        </div>
      ...
      <section>
        <div>
          <ul class="flex flex-wrap text-sm font-medium text-center text-gray-500 dark:text-gray-400 mb-5">
            ...
            <li class="mr-2">
              <button class="inline-block px-4 py-3 rounded-lg hover:text-white"
                :class="{ 'text-amber-200 bg-amber-200 bg-opacity-10': activeTab === 2 }" @click="activeTab = 2">Design Stack</button>
            </li>
            <li class="mr-2">
              <button class="inline-block px-4 py-3 rounded-lg hover:text-white"
                :class="{ 'text-amber-200 bg-amber-200 bg-opacity-10': activeTab === 3 }" @click="activeTab = 3">Tools</button>
            </li>
          </ul>
        </div>
